...
import { FlatList, StyleSheet, Text, View, TextInput, TouchableOpacity, Image, Keyboard, Dimensions, ImageBackground } from "react-native";
...
export default function Chat(props) {
  ...
  useEffect(() => {
    const keyboardDidShowListener = Keyboard.addListener(
      "keyboardDidShow",
      ({ endCoordinates }) => {
        setKeyboardHeight(endCoordinates.height/20);
      }
    );
